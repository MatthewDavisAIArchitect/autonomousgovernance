...
// Artifact IDs reflect the registry manifest — update if IDs differ from corpus-bundle.json.
...
// Keyed lookup for use in GlossaryTooltip and corpus reader.
export const GLOSSARY_MAP: Record<string, GlossaryTerm> = Object.fromEntries(
  GLOSSARY_TERMS.map((t) => [t.term, t])
)

// Sorted alphabetically for the Glossary page (Task 4c).
